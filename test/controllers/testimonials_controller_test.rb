...
class TestimonialsControllerTest < ActionController::TestCase
  ...
  test "should create testimonial" do
    assert_difference('Testimonial.count') do
      post :create, testimonial: { name: @testimonial.name, picture: @testimonial.picture, provider: @testimonial.provider, testimonial: @testimonial.testimonial }
    end
  ...
  test "should update testimonial" do
    patch :update, id: @testimonial, testimonial: { name: @testimonial.name, picture: @testimonial.picture, provider: @testimonial.provider, testimonial: @testimonial.testimonial }
    assert_redirected_to testimonial_path(assigns(:testimonial))
  end
